"""
RunPod Serverless Handler - Network Volume Version
Model is loaded from /runpod-volume/Wan2.2-Animate-14B
"""
...
# Paths - Model on network volume
MODEL_DIR = Path("/runpod-volume/Wan2.2-Animate-14B")
